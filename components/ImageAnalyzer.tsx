        ...
        <div>
          {image ? (
            <div className="relative">
              <img src={image} alt="Preview" className="rounded-lg w-full h-auto object-contain max-h-96 border border-border" />
              <button onClick={() => setImage(null)} className="absolute top-2 right-2 bg-black/50 rounded-full p-1.5 hover:bg-black">
